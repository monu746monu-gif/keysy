...
export const metadata: Metadata = {
  title: "About — Keysy",
  description:
    "Keysy is a hobby open-source typing test inspired by Monkeytype.",
}
    ...
    <main className="flex flex-1 flex-col px-6 py-10 md:py-16">
      <article className=" w-full mx-auto max-w-site space-y-6 text-muted-foreground">
        ...
        <p className="leading-relaxed">
          Keysy is a small side project: a clean, browser-based typing speed
        ...
        <p className="leading-relaxed">
          ...
          , a benchmark for minimal typing-test design. Keysy is not affiliated
        ...
        <p className="leading-relaxed">
          Keysy uses Google Analytics to collect anonymous usage data such as typing
