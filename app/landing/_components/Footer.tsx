...
<svg xmlns="http://www.w3.org/2000/svg" width="260" height="88" viewBox="0 0 260 88">
  <g fill="${CYAN}" fill-opacity="0.92" font-family="ui-monospace, SFMono-Regular, Menlo, monospace" font-size="7" letter-spacing="0.55">
    <text x="-80" y="7">KEYSY ASCII TYPE TAB ENTER WPM FLOW CTRL SHIFT ALT ESC RETURN HOME ROW</text>
    <text x="-112" y="15">0101 CTRL SHIFT ALT ESC RETURN HOME ROW QWERTY KEYSY ASCII TYPE TAB</text>
    <text x="-42" y="23">WPM ACCURACY FLOW FOCUS KEYSY CODE SPEED ZEN RETURN TAB ESC 1010</text>
    <text x="-96" y="31">ASCII MODE PRACTICE SPEED ENTER TAB KEYSY HOME ROW CTRL SHIFT WPM</text>
    <text x="-20" y="39">HOME ROW QWERTY CODE ZEN 1010 SHIFT ALT RETURN TYPE FLOW KEYSY</text>
    <text x="-124" y="47">KEY KEY KEY KEY KEY KEY KEY KEY KEY KEY KEY KEY KEY KEY KEY KEY KEY</text>
    <text x="-64" y="55">CTRL RETURN ACCURACY FOCUS FLOW TYPE KEYSY ASCII WPM TAB ESC</text>
    <text x="-104" y="63">TAB ESC ENTER SPEED CODE ASCII ZEN QWERTY HOME ROW KEYSY 0101</text>
    <text x="-34" y="71">0101 HOME ROW SHIFT ALT CTRL RETURN KEYSY WPM FLOW ACCURACY TYPE</text>
    <text x="-88" y="79">KEYSY ASCII TYPE TAB ENTER WPM FLOW CTRL SHIFT ALT ESC RETURN HOME</text>
    <text x="-8" y="87">WPM ACCURACY FLOW FOCUS KEYSY CODE SPEED ZEN RETURN TAB ESC 1010</text>
  </g>
</svg>
`)}")`
