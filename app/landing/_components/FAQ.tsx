...
const FAQS = [
  {
    q: "Is Keysy free and open source?",
    a: (
      <>
        Keysy is free to use with no sign-up wall, ads, or trial lock. The code is public under Apache-2.0, so
  ...
  },
  {
    ...
    a: (
      <>
        Keysy mirrors real key presses and highlights keys live on desktop layouts. You can switch keyboard styles
  ...
  },
  {
    ...
    a: (
      <>
        Yes. Keysy ships with a broad language manifest (including RTL scripts like Arabic, Urdu, Persian, and
  ...
  },
  {
    ...
    a: (
      <>
        Keysy stores your local preferences in your browser (for example theme, keyboard/sound toggles, and related
  ...
  {
    q: "Is Keysy affiliated with Monkeytype?",
    a: (
      <>
        No. Keysy is an independent hobby project inspired by Monkeytype&apos;s clean UX pattern, with its own
