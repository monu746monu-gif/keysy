...
export const ACCENT_COLORS: { id: AccentColor; label: string; swatch: string }[] = [
  { id: "teal",       label: "Bright Green", swatch: "oklch(0.82 0.27 145)" },
  ...
  { id: "blue",       label: "Bright Green", swatch: "oklch(0.82 0.27 145)" },
  { id: "orange",     label: "Orange",      swatch: "oklch(0.68 0.2 50)"   },
  { id: "cyan",       label: "Bright Green", swatch: "oklch(0.82 0.27 145)" },
  { id: "pink",       label: "Pink",        swatch: "oklch(0.62 0.22 330)" },
  { id: "indigo",     label: "Bright Green", swatch: "oklch(0.82 0.27 145)" },
  ...
  { id: "sky",        label: "Bright Green", swatch: "oklch(0.82 0.27 145)" },
