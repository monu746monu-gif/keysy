              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className="flex h-7 w-full items-center justify-center rounded-sm bg-lime-400/90 text-black opacity-80 transition-all duration-150 hover:opacity-100"
                  >
                    <motion.span
