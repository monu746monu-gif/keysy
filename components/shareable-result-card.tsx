...
export function ScreenshotButton({ stats, pb }: ScreenshotButtonProps) {
  ...
  const handleDownload = useCallback(async () => {
    try {
      ...
      link.download = `keysy-${Date.now()}.png`
      link.href = dataUrl
      link.click()
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {formatShareDate(new Date())} | keysy.theshiva.xyz
        </span>
      </div>
